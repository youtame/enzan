...
export default {
    ...
    head: [
        ...
        [
            "link",
            {
                rel: "icon",
                type: "image/png",
                href: "/enzan/favicon/favicon-96x96.png",
                sizes: "96x96",
            },
        ],
        [
            "link",
            {
                rel: "icon",
                type: "image/svg+xml",
                href: "/enzan/favicon/favicon.svg",
            },
        ],
        ...
        [
            "link",
            {
                ...
                sizes: "180x180",
                href: "/enzan/favicon/apple-touch-icon.png",
            },
        ],
        ...
        [
            "meta",
            {
                ...
                content:
                    "少ない更新頻度とライトな記事で手軽に読める鉄道に関するブログサイト",
            },
        ],
        ...
        [
            ...
            {
                async: "",
                src: "https://www.googletagmanager.com/gtag/js?id=G-E0J4HP2C0T",
            },
        ],
        [
            "script",
    ...
    themeConfig: {
        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        text: "塩山駅に行ったときの話",
                        link: "/article/20251120",
                    },
                    { text: "横浜市営地下鉄の進化", link: "/article/20251121" },
                    { text: "一泊二日の寄り道", link: "/article/20251122" },
                    {
                        text: "三重県伊賀市へ行った話",
                        link: "/article/20251123",
                    },
                    {
                        text: "東京から１時間で行ける秘境",
                        link: "/article/20251204",
                    },
                    {
                        text: "南武線のダイヤ改正2024",
                        link: "/article/20251206",
                    },
                    {
                        text: "シンガポールのMRTの話",
        ...
        footer: {
            message:
                'ライセンス及びその詳細は<a href="/enzan/about">「このサイトについて」</a>をご覧ください',
